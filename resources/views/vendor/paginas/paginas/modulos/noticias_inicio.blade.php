            ...
            <a href="{{route('noticias', $noticia)}}" class="nav-link p-0">
              <div class="card">            
                  <figure class="figure m-0">
                        <img src="/images/paginas-grande/{{$noticia->imagen_principal != 'no-imagen.jpg' ? $noticia->imagen_principal : 'familia.jpg' }}" class="card-img-top" alt="...">
                  </figure>               
        ...
        <div class="row row-cols-2 row-cols-md-2">
            ...
            <div class="col mb-4">           
                <div class="card">
                    <a href="{{route('noticias',$noticia)}}" class="nav-link p-0">
                          <figure class="figure m-0">
                            <img src="/images/paginas-grande/{{$noticia->imagen_principal != 'no-imagen.jpg' ? $noticia->imagen_principal : 'familia.jpg' }}" class="card-img-top rounded-10" alt="...">
                          </figure>                   
                          <div class="card-body">
       ...
       <div class="row mb-3 border py-5">      
           <div class="col-12 col-md-4 col-lg-3"> 
                <figure class="figure mb-0">
                       <img src="/images/paginas-grande/{{$noticia->imagen_principal != 'no-imagen.jpg' ? $noticia->imagen_principal : 'familia.jpg' }}" class="figure-img img-fluid w-100 rounded mb-0" alt="...">
               </figure>                          
           </div>
    ...
    <div class="container py-5 px-lg-3">
      <div class="row">
        ...
        <div class="col-sm-7 col-md-7 mb-4">
              <a href="{{route('noticias',$chunkNoticia->first())}}" class="nav-link p-0">
                  <figure class="figure m-0 w-100">
                    <img src="/images/paginas-grande/{{$chunkNoticia->first()->imagen_principal != 'no-imagen.jpg' ? $chunkNoticia->first()->imagen_principal : 'familia.jpg' }}" class="card-img-top  rounded-10" alt="...">
                  </figure>         
                  <div class="card-body">
        ...
        @if($chunkNoticia->get(1))
            <div class="col-sm-5 col-md-5 mb-4">
                <a href="{{route('noticias',$chunkNoticia->get(1))}}" class="nav-link p-0">
                    <figure class="figure m-0 w-100">
            ...
            @if($chunkNoticia->get(2))
                        <div class="col-sm-5 col-md-5 mb-4">    
                            <a href="{{route('noticias',$chunkNoticia->get(2))}}" class="nav-link p-0">
                                <figure class="figure m-0 w-100">
                                <img src="/images/familia_2.jpg" class="card-img-top  rounded-10" alt="...">
                                </figure>         
                                <div class="card-body">
                        ...
                        @if($chunkNoticia->get(3))
                            <div class="col-sm-7 col-md-7 mb-4">      
                                    <a href="{{route('noticias',$chunkNoticia->get(3))}}" class="nav-link p-0">
                                        <figure class="figure m-0 w-100">
