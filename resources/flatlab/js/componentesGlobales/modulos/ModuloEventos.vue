    ...
    <section class="card border border-primary">
        ...
        <div class="card-body modulos-body collapse show" :id="id_modulo">
           ...
           <!--  <div class="form-group row">
            ...
            <div class="form-group row">
                <label for="cantidad" class="control-label col-lg-3 my-auto"
                    >Total de Eventos</label
                >
                <div class="col-lg-9">
                    <select
                        name="cantidad"
                    ...
                    >
                        ...
                        ></option>
                        <option
                            :value="campos.columnas * 2"
                            v-text="`Columnas x 2`"
                        ></option>
                        <option
                            :value="campos.columnas * 3"
                            v-text="`Columnas x 3`"
                        ></option>
                        <option
                            :value="campos.columnas * 4"
                            v-text="`Columnas x 4`"
                        ></option>
                    </select>
                </div>
            ...
            <div class="form-group row" v-if="campos.tipo == 'tipo'">
                ...
                <div class="col-lg-9">
                    <select
                        name="tipo_id"
                        class="form-control"
                        :value="campos.tipo_id"
                        @change="
                            cambiaCampo($event.target.name, $event.target.value)
                        "
                        placeholder="Tipos de eventos a mostrar"
                    >
                        <option
                            v-for="(tipo, index) in tipos_evento"
                            :value="tipo.id"
                            :key="index"
                            v-text="tipo.nombre"
                            :selected="tipo.id == campos.tipo_id"
                        ></option>
                    </select>
                </div>
            </div> -->
