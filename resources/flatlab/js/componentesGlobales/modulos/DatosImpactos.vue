<template>
      <section class="card border border-primary">
        ...
        <div ref="caja" class="card-body modulos-body collapse show" :id="id_modulo">
                ...
                <div class="form-group row" >
                    <label for="texto" class="control-label col-lg-3 my-auto" >Titulo Principal</label>
                    <div class="col-lg-9">
                        ...
                        <div class="card bg-primary tasks-widget border border-primary"  v-for="(modulo,index) in modulos" :key="index">
                            ...
                            <div class="card-body bg-white text-dark">
                            	<div class="task-content" >
                                    ...
                                    <div class="form-group">
                                        <div class="col-lg-12 row">
                                            <label class="col-lg-2 my-auto">Texto Link</label>
                                            <input class="form-control col-lg-10 "  v-model="modulo.texto_link" placeholder="Icono del módulo">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <div class="col-lg-12 row">
                                            <label class="col-lg-2 my-auto">Link</label>
                                            <input class="form-control col-lg-10 "  v-model="modulo.link" placeholder="Icono del módulo">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <div class="col-lg-12 row">
                                            <label class="col-lg-2 my-auto">Porcentaje</label>
                                            <input class="form-control col-lg-10 "  v-model="modulo.porcentaje" placeholder="Icono del módulo">
                                        </div>
                                    </div>
                            	</div>
                            </div>
...
<script>
	...
	export default {
	    ...
	    methods: {
	        ...
	        agregarModulo() {
	        	this.modulos.push({titulo:'', texto:'',texto_link:'', link:'', porcentaje:''})
            },
            toggle(event){
