    ...
    <div class="col-md-6 mb-4">
        <div class="card flex-md-row  shadow-sm h-100">
            <div class="card-body d-flex flex-column align-items-start">
                ...
                <p class="blog-post-meta">Publicado el {{ $noticia->created_at->format('d/m/Y') }} en <a
                        href="{{ $tema->path }}">{{ $tema->nombre }}</a></p>
            ...
            <img class="card-img-right flex-auto d-none d-lg-block"
                data-src="/images/thumbnoticia/{{ $noticia->imagen_principal }}" alt="{{ $noticia->titulo}}"
                src="/images/thumbnoticia/{{ $noticia->imagen_principal }}" data-holder-rendered="true">
        </div>
    </div>
    @empty
