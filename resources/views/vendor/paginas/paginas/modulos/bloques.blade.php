                        ...
                        <div class="row row-cols-1 row-cols-sm-2 row-cols-md-3 row-cols-lg-{{$campos['columnas']}} mt-4 text-center">
                            ...
                            <div class="col mb-4">  
                                <div class="card bg-light border-0">           
                                    <a href="{{isset($modulo['link']) ? $modulo['link'] : '#'}}" class="nav-link p-0" target="_blank">                 
                                            <figure class="figure m-0">
                                                <img src="/images/paginas-grande/{{ isset($campos['imagen']) ? $campos['imagen'] : 'familia.jpg' }}" class="card-img-top rounded-10" alt="...">
                                            </figure>                             
                        ...
                        <div class="row justify-content-between my-2 my-md-5">
                            ...
                            <div class="col-lg-6 row mb-3 mx-auto {{$key % 2 == 0 ? 'border-dr' : ''}}">
                                <div class="col-12 col-md-6">
                                    <a href="{{isset($modulo['link']) ? $modulo['link'] : '#'}}" target="_blank">
                                        <figure class="figure mb-0">
                                            <img class="img-fluid mb-0" src="/images/paginas-grande/{{ isset($campos['imagen']) ? $campos['imagen'] : 'familia.jpg' }}" alt="">
                                        </figure>
                                    </a>              
                                </div>
