    ...
    <section class="card border border-primary">
        ...
        <div class="card-body modulos-body collapse show" :id="id_modulo">
            ...
            <div class="form-group row" >
                ...
                <div class="col-lg-9">
                    <select name="columnas" class="form-control " :value="campos.columnas" @change="cambiaCampo($event.target.name, $event.target.value)" placeholder="Noticias x linea" >
            ...
            <div class="form-group row" >
                <label for="cantidad" class="control-label col-lg-3 my-auto" >Total de Noticias</label>
                <div class="col-lg-9">
                    <select name="cantidad" class="form-control " :value="campos.cantidad" @change="cambiaCampo($event.target.name, $event.target.value)" placeholder="Noticias x linea" >
            ...
            <div class="form-group row">
                ...
                <div class="col-lg-9">
                    <select name="tipo" class="form-control " :value="campos.tipo" @change="cambiaCampo($event.target.name, $event.target.value)" placeholder="Noticias a mostrar" >
