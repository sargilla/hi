...
<article id="eventosDescripcion" class="eventosShow">
    <div class="py-3 px-5 ">
        <div class="mt-5 mt-lg-0 col-md-8 col-lg-7 col-xl-6 p-0">
            ...
            <h3>
                Lorem ipsum dolor sit amet consectetur adipisicing elit. Reiciendis facilis molestiae provident
                voluptatem quibusdam sequi perspiciatis hic eum labore rerum!
            </h3>
        </div>
    </div>
</article>
