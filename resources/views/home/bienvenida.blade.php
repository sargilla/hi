    ...
    <div class="container-fluid mt-5">
        <div class="row justify-content-center align-items-center py-3 px-lg-3">
            <div class="col-md-6 col-xl-7 px-md-3 px-lg-5">
                ...
                <p class="my-4">
                    Bienvenidas y bienvenidos en este espacio que promueve una gestión del riesgo de desastres con
                    enfoque de inclusión, poniendo a las personas en situación de mayor vulnerabilidad en el centro de
                    la gestión del riesgo, haciéndolessiendo partícipes como personas sujetas de derechos, en
                    condiciones de igualdad, sin exclusiones ni discriminación.
                </p>
                <p>
